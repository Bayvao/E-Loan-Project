...
import com.elaon.service.LoanAcceptanceServiceImpl;
...
public class PaymentController {
	...
	@Autowired
	LoanAcceptanceServiceImpl lsri;
	...
	public String loanPayment(@Valid @ModelAttribute("payment") Payment payment, BindingResult result, Model model,
		...
		if (exists) {
			...
			LoanAcceptance accept = lsri.findLoanById(lNo);
			...
			model.addAttribute("paymentError", "Loan Number doesnot exists");
