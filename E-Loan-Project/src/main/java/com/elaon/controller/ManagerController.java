...
public class ManagerController {
	...
	@GetMapping("/loanAcceptanceDetail")
	public String acceptanceDetails(@RequestParam String id, Model model, HttpSession session) {
		
		Long loanNumber = Long.parseLong(id);
		
		LoanAcceptance accept = loanAcceptService.findLoanById(loanNumber);
